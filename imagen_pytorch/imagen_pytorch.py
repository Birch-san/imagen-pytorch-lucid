...
def cast_tuple(val: _TupleOrListOrSingle[_T], length = None) -> Tuple[_T, ...]:
...
class Imagen(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        unets: Tuple[Unet, ...] = cast_tuple(unets)
        ...
        noise_schedules: Tuple[_NoiseSchedule, ...] = cast_tuple(noise_schedules)
